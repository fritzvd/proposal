...
beliefs expressed in instruments such as policies, or punitive action or
attitudes of individuals. Beliefs about ``inevitability of technology''
and the cult of innovation (Winner 2018) pervade, while at the same time
mistrust and weariness keeps AI out of universities (Guest et al. 2025).
...
The threats and opportunities for the achieved agency of adoloscents are
...
1998, 975) by uncovering what beliefs and habits belie the day-to-day
tasks that interact with AAI. Thirdly I will investigate how students
enact their intentions within their temporal-relational context of
action and how their achieving of agency shapes their context. This
means looking into the \emph{prospective} dimension of the chordal triad
(Emirbayer and Mische 1998, 984), where goals or aspirations are set and
then actualized through the \emph{practical-evaluative} dimension.
...
\item
  In what way is the ecology in which action is performed changing
  because of AAI?
\item
...
RQ3 & In what way is the ecology in which action is performed changing
because of AAI? & Longitudinal study \\
RQ4 & In what ways are students performing day-to-day tasks, by either
...
\subsubsection{RQ3: Experiment}\label{rq3-experiment}
...
better way to deal and cope with these technologies helps students to
use these more properly. The survey used for RQ2 could then again be
used to see if this changes anything.

\subsubsection{RQ4: Mixed-method}\label{rq4-mixed-method}
...
As Biesta and Tedder (2007) interacts with Emirbayer and Mische (1998)
we get a

\includegraphics[width=2.96in,height=3.15in]{proposal-2026-04_files/figure-latex/mermaid-figure-2.png}

\textsubscript{Source:
\href{https://fritzvd.github.io/proposal/proposal-2026-04.qmd.html}{Article
Notebook}}
