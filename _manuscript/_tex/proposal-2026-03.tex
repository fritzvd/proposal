...
2019; Swanepoel 2021). If yes, then perhaps not agency ``arising from
beliefs, desires and reasons'' (Dattathrani and De' 2023).
...
and be able to exercise power over a situation in certain context.
...
1999). The role technology plays in society and the way it interacts
with our human agency has been a topic of much debate {[}{]}, with
...
has not been studied, apart from the influence it has on critical
...
(Habermas 1971 pp.) is in direct opposition to the hegemony of Silicon
...
action by one's own beliefs. The concepts of agency put forward by
Giddens (1984) and Bandura (2001) emphasise different dimensions. Where
Giddens focuses on the social structure and its society: ``making a
difference'', Bandura focuses on aspects that make up individual agency,
\emph{intentionality, forethought, self-reactiveness and
self-reflectiveness}.
